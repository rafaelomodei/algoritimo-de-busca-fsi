...
def depthFirstSearch(graph: dict, initialCell: Cell, goalCell: Cell) -> float and Cell and None:
    punishment: float = 0
    ...
    while queueCell:
        ...
        currentCell = queueCell.pop() #remove o primeiro elemento que entrou na lista
